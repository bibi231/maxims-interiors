            ...
            <section className="section-base bg-cream-soft">
                <div className="max-w-[1200px] mx-auto columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                    {loading && Array.from({ length: 6 }).map((_, i) => (
                        <div key={`skel-${i}`} className="break-inside-avoid bg-card border border-purple-rich/5 p-8 animate-pulse">
                    ...
                    {(reviews || []).map((r, i) => (
                        <motion.div key={r.id} className="break-inside-avoid bg-card border border-purple-rich/5 p-8 relative group"
